...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>accueil_admin | Bureau des etudiants TWF</title>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="accueil_admin.php" class="active"> Offres d'emploies </a>
              </li>
              <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title mb-30">
                  <h2>Bureau des Etudiants TWF Dashboard</h2>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
          ...
          <div class="row">
            <div class="dropdown" style="text-align: right;">
              ...
              <i class="fa fa-filter" style = "color:yellow; margin-right:5px;"></i>Filtrer
              </button>
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="accueil_admin.php">Tous les parcours</a></li>
                <li><a class="dropdown-item" href="accueil_admin.php?parcours=art_numerique">Art Numérique</a></li>
                <li><a class="dropdown-item" href="accueil_admin.php?parcours=developpement_web">Développement web</a></li>
                <li><a class="dropdown-item" href="accueil_admin.php?parcours=data_science">Data Science</a></li>
              </ul>
            </div>
            <div class="col-lg-12">
              <div class="card-style mb-30">
                ...
                >
                  <div class="left">
                    <h6 class="text-medium mb-30">Toutes les offres</h6>
                  </div>
                  
                  <div class="right">
                    <!-- <div class="select-style-1">
                      <div class="select-position select-sm">
                        <form action="accueil_admin.php" method="GET">
                          <select class="light-bg" name="parcours">
                  ...
                  <table class="table top-selling-table">
                    <thead>
                      <tr>
                        ...
                        <th>
                          <h6 class="text-sm text-medium">Titre de l'Offre</h6>
                        </th>
                        <th class="min-width">
                          <h6 class="text-sm text-medium">Parcours</h6>
                        </th>
                        <th class="min-width">
                          <h6 class="text-sm text-medium">Structure</h6>
                        </th>
                        <th class="min-width">
                          <h6 class="text-sm text-medium">Date line</h6>
                        </th>
                        <th class="min-width">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img
                                src="assets/images/offres/job.jpg"
                                alt=""
                              />
                            </div>
                            <p class="text-sm"><?= $offre ->titreOffre ?></p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm"><?= $offre ->parcours ?></p>
                        </td>
                        <td>
                          <p class="text-sm"><?= $offre ->nomStructure ?></p>
                        </td>
                        <td>
                          <p class="text-sm"><?= $offre ->dateLimite ?></p>
                        </td>
                        <td>
                          <p class="text-sm"><?= $offre ->lieu ?></p>
                        </td>
                        <td>
                          <div class="action justify-content-end">
                            ...
                            >
                              ...
                              <li class="dropdown-item">
                                <a href="new_offre.html" class="text-gray">Modifier</a>
                              </li>
                            </ul>
                          </div>
                        </td>
