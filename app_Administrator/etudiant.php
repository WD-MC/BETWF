...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>etudiant | Bureau des etudiants TWF</title>
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th><h6>Parcours</h6></th>
                          <th><h6>Status</h6></th>
                          <th><h6>Notation</h6></th>
                          <th><h6>Exactitude</h6></th>
                          <th><h6>Action</h6></th>
                        </tr>
                        <!-- end table row-->
                      </thead>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Ajoutez une notation à l'étudiant</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            
                            <div class="ml-15 mr-15 mt-4">
                              <!-- <input type="number" name="notation" placeholder="notation" />
                              <input type="text"  name="exactitude" placeholder="exactitude" /> -->
                            ...
                            <div class="modal-footer">
                              ...
                              <a href="#" style=" text-decoration:none; margin-right:5px; padding:8px; background-color: #2A496D;color:white; border-radius:5px;" >
                                  Enregistrer</a>
                            </div>   
                          </div> 
                        </div>
